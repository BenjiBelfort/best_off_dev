...
const Biographie = () => {
    return (
      <section id="biographie" className="scroll-mt-20 mx-auto max-w-2xl px-4 py-8 text-white">
          <h3>Biographie</h3>
          <h4 className="font-bold text-2xl sm:text-3xl bg-gradient-to-r from-orange-50 via-white to-yellow-50 bg-clip-text text-transparent font-secondary text-left">L’alliance puissante du rock et de la symphonie au service de la musique et de la solidarité</h4>
          <br />
          ...
          <br />
          <h4 className="font-bold text-2xl sm:text-3xl bg-gradient-to-r from-orange-50 via-white to-yellow-50 bg-clip-text text-transparent font-secondary text-left">Une formation riche et éclectique</h4>
          <p>Avec une palette sonore aussi variée que captivante, BEST OFF' réunit des talents complémentaires : violons, cuivres, guitares, basse, batterie, clavier, chanteurs et chanteuses se répondent pour créer des arrangements uniques. Chaque concert est une odyssée musicale, où les tubes intemporels sont réinventés avec puissance et émotion.</p>
          <br />
          <h4 className="font-bold text-2xl sm:text-3xl bg-gradient-to-r from-orange-50 via-white to-yellow-50 bg-clip-text text-transparent font-secondary text-left">La musique au service des autres</h4>
          <p>Au-delà de la scène, BEST OFF' s’engage : depuis ses débuts, le groupe organise des concerts au profit d’associations caritatives, transformant la passion en actions solidaires. Que ce soit pour soutenir des causes locales ou nationales, leur démarche artistique est toujours guidée par l’envie de partager et d’aider.</p>
          <br />
          <h4 className="font-bold text-2xl sm:text-3xl font-secondary text-left bg-gradient-to-r from-orange-50 via-white to-yellow-50 bg-clip-text text-transparent">Une décennie de passion et de partage</h4>
