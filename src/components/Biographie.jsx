...
const Biographie = () => {
    return (
      <section id="biographie" className="scroll-mt-20 mx-auto max-w-2xl px-4 py-8 text-white">
          ...
          <p className="text-center">Quand le <span className='font-special text-3xl'>Rock </span> rencontre la <span className='font-special text-3xl'>Symphonie </span> pour la solidarité</p>
          <img
            className="mt-5"
