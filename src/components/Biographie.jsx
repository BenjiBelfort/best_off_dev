...
const Biographie = () => {
    return (
      <section id="biographie" className="scroll-mt-20 mx-auto max-w-2xl px-4 py-8 text-white">
          ...
          <br />
          <p className="font-bold text-2xl my-2">Une formation riche et éclectique</p>
          ...
          <br />
          <p className="font-bold text-2xl my-2">La musique au service des autres</p>
          ...
          <br />
          <p className="font-bold text-2xl my-2">Une décennie de passion et de partage</p>
