...
const Biographie = () => {
    return (
      <section id="biographie" className="scroll-mt-20 mx-auto max-w-2xl px-4 py-8 text-white">
          ...
          <p className="text-justify">Avec une palette sonore aussi variée que captivante, BEST OFF' réunit des talents complémentaires : batterie, guitares, basse, chanteurs et chanteuses, cuivres, clavier et violons se répondent pour créer des arrangements uniques. Chaque concert est une odyssée musicale, où les tubes intemporels sont réinventés avec puissance et émotion.</p>
          <br />
          <p className="font-bold pt-2">La musique au service des autres</p>
          <p className="text-justify">Au-delà de la scène, BEST OFF' s’engage : depuis ses débuts, il organise des concerts au profit d’associations caritatives, transformant la passion en actions solidaires. Que ce soit pour soutenir des causes locales ou nationales, leur démarche artistique est toujours guidée par l’envie de partager et d’aider.</p>
          <br />
          ...
          <br />
          <p className="text-center font-primary text-2xl">BEST OFF'</p>
