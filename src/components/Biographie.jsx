...
const Biographie = () => {
    return (
      <section id="biographie" className="scroll-mt-20 mx-auto max-w-2xl px-4 py-8 text-white">
          <h3>Biographie</h3>
          <p className="font-bold text-2xl sm:text-3xl text-stone-300">L’alliance puissante du rock et de la symphonie au service de la musique et de la solidarité</p>
          <br />
          ...
          <br />
          <p className="font-bold text-2xl sm:text-3xl text-stone-300 my-2">Une formation riche et éclectique</p>
          ...
          <br />
          <p className="font-bold text-2xl sm:text-3xl text-stone-300 my-2">La musique au service des autres</p>
          ...
          <br />
          <p className="font-bold text-2xl sm:text-3xl text-stone-300 my-2">Une décennie de passion et de partage</p>
